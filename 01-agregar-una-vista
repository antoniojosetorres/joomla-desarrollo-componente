...
````
* Crear la carpeta `views` en `site/views/`.
* Crear el fichero `index.html` en `site/views/index.html`:
````html
	<html><body bgcolor='#fff'></body></html>
````
* Crear la carpeta `helloworld` en `site/views/helloworld/`.
* Crear el fichero `index.html` en `site/views/helloworld/index.html`:
````html
	<html><body bgcolor='#fff'></body></html>
````
...
````
* Crear la carpeta `tmpl` en `site/views/helloworld/tmpl/`.
* Crear el fichero `index.html` en `site/views/helloworld/tmpl/index.html`:
````html
	<html><body bgcolor='#fff'></body></html>
````
